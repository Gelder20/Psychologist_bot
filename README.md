...
Обратиться в службу поддержки можно на любом этапе взаимодействия с ботом. Само обращение в службу поддержки - это диалог клиента со специалистом через бота. Также, если бот выявит плохой эмоциональный окрас сообщения во время общения клиента с ботом, то специалист будет вызван автоматически.
